...
depending on varying dataframes for the research question 5'''

import pandas as pd
import pytest
import numpy as np
from view.rq_5_land_co2 import plot_data
...
def test_plot_without_data():
    ...
    try:
        ...
        pytest.fail("Expected no error with empty dataframe")
...
def test_plot_data():
    ...
    try:
        ...
        pytest.fail("Expected no error with valid dataframe")
