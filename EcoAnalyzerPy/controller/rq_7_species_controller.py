...
from rq_7_species import calculate_total
from rq_7_species_view import show_total

# now we import our functions from our module
df = get_data()
total_endangered_species = calculate_total(df)

def research_question_seven():
    # we pass the result from the model to the view
    show_total(total_endangered_species)
